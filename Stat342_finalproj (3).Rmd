...
The plot illustrates the 95% confidence intervals for the vaccine efficacy estimate over 100 bootstrap samples, with the observed Method of Moments estimate represented by a red dashed line. The red line, which represents an efficacy estimate of about 0.95, falls within all of the bootstrap samples' blue intervals. This shows that the observed MOM estimate is relatively robust. Therefore, we can conclude from this figure that the observed MOM estimate of approximately 0.95 indicates a high level of vaccine efficacy.
